  ...
  const convertDataRequestToHTTP = (type, resource, params) => {
    ...
    switch (type) {
      ...
      case UPDATE:
        ...
        const updateData = {
          ...params.data,
          categories: Array.isArray(params.data.categories) ? params.data.categories : params.data.categories.split(','),
          actors: Array.isArray(params.data.actors) ? params.data.actors : params.data.actors.split(',')
        }
      ...
      case CREATE:
        ...
        const createData = {
          ...params.data,
          categories: params.data.categories.split(','),
          actors: params.data.actors.split(',')
        }
